  ...
  const screens = [
    {
      ...
      location: 'г.Есик, Центральный мост',
      image: '/images/Центральный Мост.jpg',
      basicPackage: '80 000 ₸',
      basicOutputs: '480 выходов',
      premiumPackage: '130 000 ₸',
      premiumOutputs: '960 выходов',
      views: 'Охват: по ул.Алматинская в северном направлении',
      features: ['10 секунд', '18кв.м площадь монитора', 'Круглосуточно'],
      resolution: '720×360 пикселей'
    },
    {
      id: 2,
      name: 'Дом культуры',
      location: 'г.Есик, возле ДК',
      image: '/images/ДК.jpg',
      basicPackage: '80 000 ₸',
      basicOutputs: '480 выходов',
      premiumPackage: '130 000 ₸',
    ...
    },
    {
      ...
      location: 'г.Есик, ул.Алтын Адам, уг.ул.Уалиханова',
      image: '/images/Алтын Адам.jpg',
      basicPackage: '80 000 ₸',
      basicOutputs: '480 выходов',
      premiumPackage: '130 000 ₸',
      premiumOutputs: '960 выходов',
    ...
    },
    {
      ...
      location: 'г.Талгар, Центральная площадь',
      image: '/images/Площадь.jpg',
      basicPackage: '80 000 ₸',
      basicOutputs: '480 выходов',
      premiumPackage: '130 000 ₸',
      premiumOutputs: '960 выходов',
      ...
      <div className="relative z-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto" ref={sectionRef}>
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Стратегически расположенные экраны в самых проходимых местах Алматинской области
          </p>
        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
              ...
              <div className="p-8 lg:p-10 flex flex-col justify-center">
                ...
                <div className="text-gray-600 mb-8 leading-relaxed">
                  <p>Премиальное расположение с высоким трафиком и отличной видимостью</p>
                  <p className="mt-2 text-purple-600 font-medium">
                    <Monitor className="inline h-5 w-5 mr-2" />
                    Разрешение экрана: {screens[activeScreen].resolution}
                  </p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center p-4 bg-gray-50 rounded-xl border border-gray-100 hover:border-purple-200 transition-colors duration-200">
                    <div className="text-xl font-bold text-gray-900 mb-1">
                      {screens[activeScreen].basicOutputs}
                    </div>
                    <div className="text-gray-600 text-sm">
                      {screens[activeScreen].basicPackage}
                    </div>
                  ...
                  <div className="text-center p-4 bg-gray-50 rounded-xl border border-gray-100 hover:border-purple-200 transition-colors duration-200">
                    <div className="text-xl font-bold bg-gradient-to-r from-purple-500 to-pink-500 bg-clip-text text-transparent mb-1">
                      {screens[activeScreen].premiumOutputs}
                    </div>
                    <div className="text-gray-600 text-sm">
                      {screens[activeScreen].premiumPackage}
                    </div>
                    <div className="text-gray-500 text-xs mt-1">
                      в месяц
                    </div>
...
//   <p className="mt-2 text-purple-600 font-medium">
//     <Monitor className="inline h-5 w-5 mr-2" />
//     Разрешение экрана: {screens[activeScreen].location.includes('Талгар') 
//       ? '480×288 пикселей' 
//       : '720×360 пикселей'}
//   </p>
// </div>
